...
const Data = () => {
    return (
        <div className="home__data">
            <h1 className="home__title">Shwetha
                <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
            ...
            <p className="home__description">
                I'm a React designer based in Coimbatore,
                aiming to create user-friendly projects with a focus on simplicity and functionality.
            </p>
